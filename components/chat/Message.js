...
// import { CalendarDays, MapPin, Hash, MessageSquare, Bookmark, BookmarkCheck } from "lucide-react";
...
//     if (!Array.isArray(channels)) return null;
//     for (const channel of channels) {
//       const city = channel.cities.find((c) => c.name.toLowerCase() === cityName.toLowerCase());
//       if (city) return channel.emoji;
//     }
//     return null;
//   };
...
//           </span>
//         </div>
//         <div className="text-sm leading-relaxed break-words mt-1">{parseContent(message.content)}</div>
